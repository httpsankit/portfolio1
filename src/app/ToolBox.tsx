...
import { DiJavascript, DiNodejs, DiPython, DiMongodb, DiPostgresql } from 'react-icons/di';
...
const languageTools: Tool[] = [
	{
		index: 0,
		name: 'JavaScript',
		icon: <DiJavascript className="m-4 text-6xl text-yellow-700 hover:scale-105" />,
	},
	{
		index: 1,
		name: 'Node Js.',
		icon: <DiNodejs className="m-4 text-6xl text-green-700 hover:scale-105" />,
	},
	{
		index: 2,
		name: 'C/C++',
		icon: <TbBrandCpp className={'m-4 text-6xl text-blue-700 hover:scale-105'} />,
	},
	{
		index: 3,
		name: 'Pyhon',
